      ...
      a = function (e) {
        ...
        if (l) {
          var d,
            ...
            H = function () {
              c.is(":visible") &&
                c.fadeOut(t.speed, function () {
                  n.removeClass("magnifying").trigger("magnifyend");
                });
            };
          isNaN(+s.speed) || (t.speed = +s.speed),
            isNaN(+s.timeout) || (t.timeout = +s.timeout),
            isNaN(+s.finalWidth) || (t.finalWidth = +s.finalWidth),
            isNaN(+s.finalHeight) || (t.finalHeight = +s.finalHeight),
            isNaN(+s.magnifiedWidth) || (t.magnifiedWidth = +s.magnifiedWidth),
            isNaN(+s.magnifiedHeight) ||
              (t.magnifiedHeight = +s.magnifiedHeight),
            "true" === s.limitBounds && (t.limitBounds = !0),
            "function" == typeof window[s.afterLoad] &&
          ...
          i(W).on({
            load: function () {
              ...
              a.css("display", "block"),
                ...
                (c = d.children(".magnify-lens")).removeClass("loading"),
                (u = t.finalWidth || a.width()),
                (h = t.finalHeight || a.height()),
                (g = t.magnifiedWidth || W.width),
                (m = t.magnifiedHeight || W.height),
                (p = c.width()),
                (v = c.height()),
                (y = k()),
                t.limitBounds && ((N = p / 2 / (g / u)), (b = v / 2 / (m / h))),
                (g === W.width && m === W.height) ||
                  c.css("background-size", g + "px " + m + "px"),
                a.data("zoomSize", { width: g, height: m }),
                (W = null),
                t.afterLoad(),
                d.off().on({
                    ...
                    if ((i.preventDefault(), h)) {
                      if (
                        ...
                        c.is(":animated") ||
                          (e > N && e < u - N && f > b && f < h - b
                            ? c.is(":hidden") &&
                              (n.addClass("magnifying").trigger("magnifystart"),
                              c.fadeIn(t.speed))
                            : H()),
                        c.is(":visible"))
                      ) {
                  ...
                  d.click(function (t) {
                    if (t.clientX || t.clientY) {
                      ...
                      var n = document.elementFromPoint(
                        t.clientX || t.originalEvent.touches[0].clientX,
                        t.clientY || t.originalEvent.touches[0].clientY
                      );
                      "AREA" === n.nodeName
                        ? n.click()
                        : i("area", I).each(function () {
      ...
      (this.destroy = function () {
        return (
          this.each(function () {
            ...
            t.parent("div.magnify").length &&
              e.length &&
              (n ? t.attr("style", n) : t.removeAttr("style"),
              t.unwrap(),
              e.remove());
          }),
          i(window).off("resize", r),
          e
        );
      }),
      i(window).resize(r),
